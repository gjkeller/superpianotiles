...
#line 67 "/Users/gabriel/Documents/Arduino/game/game.ino"
void actionKeyIncreaseVolume(bool active, int pin, void *ptr);
#line 81 "/Users/gabriel/Documents/Arduino/game/game.ino"
void actionKeyDecreaseVolume(bool active, int pin, void *ptr);
#line 95 "/Users/gabriel/Documents/Arduino/game/game.ino"
void setupActions();
#line 104 "/Users/gabriel/Documents/Arduino/game/game.ino"
void setupTiles();
#line 173 "/Users/gabriel/Documents/Arduino/game/game.ino"
void getMappings(const char *mapping);
#line 197 "/Users/gabriel/Documents/Arduino/game/game.ino"
piano_note_t jsonObjToNote(JsonObject obj);
#line 255 "/Users/gabriel/Documents/Arduino/game/game.ino"
void displayNotes();
#line 411 "/Users/gabriel/Documents/Arduino/game/game.ino"
void setup();
#line 447 "/Users/gabriel/Documents/Arduino/game/game.ino"
void loop();
#line 478 "/Users/gabriel/Documents/Arduino/game/game.ino"
void setupLEDs(void *params);
#line 490 "/Users/gabriel/Documents/Arduino/game/game.ino"
void runLEDs();
#line 501 "/Users/gabriel/Documents/Arduino/game/game.ino"
void setupAudio(void *params);
#line 511 "/Users/gabriel/Documents/Arduino/game/game.ino"
void audioPlayer();
#line 522 "/Users/gabriel/Documents/Arduino/game/game.ino"
void printNote(piano_note_t note);
#line 537 "/Users/gabriel/Documents/Arduino/game/game.ino"
void handleButtonPress(bool button1, bool button2, bool button3, bool button4);
#line 542 "/Users/gabriel/Documents/Arduino/game/game.ino"
void displayColumns();
#line 67 "/Users/gabriel/Documents/Arduino/game/game.ino"
void actionKeyIncreaseVolume(bool active, int pin, void *ptr)
{
...
piano_note_t jsonObjToNote(JsonObject obj)
{
  ...
  if (notesToSet.indexOf('d') != -1)
  {
    ...
    tempNote.height_d = h["d"].is<float>() ? h["d"].as<float>() - tempNote.time : ZERO_WIDTH;
  }
  else
  {
    tempNote.height_d = 0;
  ...
  if (notesToSet.indexOf('f') != -1)
  {
    ...
    tempNote.height_f = h["f"].is<float>() ? h["f"].as<float>() - tempNote.time : ZERO_WIDTH;
  }
  else
  {
    tempNote.height_f = 0;
  ...
  if (notesToSet.indexOf('j') != -1)
  {
    ...
    tempNote.height_j = h["j"].is<float>() ? h["j"].as<float>() - tempNote.time : ZERO_WIDTH;
  }
  else
  {
    tempNote.height_j = 0;
  ...
  if (notesToSet.indexOf('k') != -1)
  {
    ...
    tempNote.height_k = h["k"].is<float>() ? h["k"].as<float>() - tempNote.time : ZERO_WIDTH;
  }
  else
  {
    tempNote.height_k = 0;
...
void printNote(piano_note_t note)
{
  ...
  Serial.print(note.time, 2); // print the time with two decimal places
  Serial.print(" sec, height_d: ");
  Serial.print(note.height_d, 2);
  Serial.print(", height_f: ");
  Serial.print(note.height_f, 2);
  Serial.print(", height_j: ");
  Serial.print(note.height_j, 2);
  Serial.print(", height_k: ");
  Serial.print(note.height_k, 2);
  Serial.println(">");
}
