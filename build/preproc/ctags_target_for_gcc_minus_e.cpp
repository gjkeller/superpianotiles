...
const CHSV colColorsLighter[4] = {
    CHSV(96, 128, 255), // Lighter green
    CHSV(0, 128, 255), // Lighter red
    CHSV(160, 128, 255), // Lighter blue-ish
    CHSV(32, 128, 255) // Lighter orange
};
...
void displayNotes()
{
  ...
  for (int i = 0; i < totalNotes; i++)
  {
    ...
    int ledStart = (int)(relStart * (colSegment / 5.0));
    int ledEnd = (int)(relEnd * (colSegment / 5.0));
    if (ledEnd <= ledStart)
    {
...
# 465 "/Users/gabriel/Documents/Arduino/game/game.ino" 3 4
     __null
# 465 "/Users/gabriel/Documents/Arduino/game/game.ino"
...
{
  Serial0.printf("Processing for %d\n", buttonColumn);
  ...
  for (int i = 0; i < totalNotes; i++)
  {
    if (notes[i].col == buttonColumn)
    {
      ...
      if ((currentTime >= (notes[i].time - 0.7)) && (currentTime <= (notes[i].time + 0.7)))
      {
