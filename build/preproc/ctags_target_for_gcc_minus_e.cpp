...
# 2 "/Users/gabriel/Documents/Arduino/game/game.ino" 2
# 3 "/Users/gabriel/Documents/Arduino/game/game.ino" 2
# 4 "/Users/gabriel/Documents/Arduino/game/game.ino" 2
...
void setupTiles()
{
  ...
  Serial0.print("Mapping: ");
  Serial0.println(mapping ? mapping : "Not found");

  Serial0.print("SrcRef: ");
  Serial0.println(srcref ? srcref : "Not found");
...
void displayNotes()
{
  ...
  for (int i = 0; i < totalNotes; i++)
  {
    ...
    if (notes[i].time >= secondsElapsed && notes[i].time < (secondsElapsed + 10.0))
    {
      ...
      int ledIndex = (int)(relativeTime * (300 / 10.0));
      ...
      uint8_t brightness = (uint8_t)((notes[i].height_d * 255) < (0) ? (0) : ((notes[i].height_d * 255) > (255) ? (255) : (notes[i].height_d * 255)));
...
void setup()
{
  ...
  AudioToolsLogger.begin(Serial0, AudioToolsLogLevel::Info);
...
# 264 "/Users/gabriel/Documents/Arduino/game/game.ino" 3 4
     __null
# 264 "/Users/gabriel/Documents/Arduino/game/game.ino"
...
void loop()
{
  ...
  {
    Serial0.println("Both buttons pressed!");
...
{
  Serial0.println("Performing special action!");
  // Add any action you want here
}

void setupLEDs(void *params) {
  FastLED.addLeds<NEOPIXEL, 23>(leds, 300);
  FastLED.clear();
